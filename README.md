...
**IMPORTANT**
When adding money to a portfolio that has already been configured, ensure that you "reconfigure" your algorithm.

If you do not, the built in profit tracking will not be able to detect the new deposit and will instead think that it is profit generated by the algorithm, resulting in unnecessary donations. Reconfiguring ensures that a new baseline is established. Any issues or inquiries can be directed to support@nescience.io
